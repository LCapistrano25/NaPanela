...
class weeklyRecipeAdmin(admin.ModelAdmin):
    list_display = ['id', 'user_id', 'recipe_id', 'week', 'month', 'year', 
                    'created_by', 'created_at', 'updated_by', 'updated_at']
    search_fields = ['user_id', 'recipe_id', 'week', 'month', 'year']
    list_filter = ['created_at', 'updated_at']
    
    fieldsets = (
        (None, {
            'fields': ('user_id', 'recipe_id', 'week', 'month', 'year')
        }),
        ('Control', {
            'fields': ('created_by', 'created_at', 'updated_by', 'updated_at'),
            'classes': ('collapse',)
...
admin.site.register(WeeklyRecipe, weeklyRecipeAdmin)
